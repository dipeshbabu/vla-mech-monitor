...
export RUN_MIXED_OOD="${RUN_MIXED_OOD:-0}"
export RUN_TASK_HELDOUT="${RUN_TASK_HELDOUT:-0}"
export RUN_UNCERTAINTY_BASELINE="${RUN_UNCERTAINTY_BASELINE:-0}"
...
echo "RUN_MIXED_OOD=${RUN_MIXED_OOD}"
echo "RUN_TASK_HELDOUT=${RUN_TASK_HELDOUT}"
echo "RUN_UNCERTAINTY_BASELINE=${RUN_UNCERTAINTY_BASELINE}"
